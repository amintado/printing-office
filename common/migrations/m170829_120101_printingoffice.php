...
class m170829_120101_printingoffice extends \yii\db\Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%access}}', [
            ...
            'time' => $this->datetime()->notNull()->defaultValue('CURRENT_TIMESTAMP'),
            'uid' => $this->integer(11),
            'UUID' => $this->string(32),
            'lock' => $this->bigInteger(20),
            'created_at' => $this->date(),
            ...
            'description' => $this->text()->notNull(),
            'RegisterTime' => $this->datetime()->notNull()->defaultValue('CURRENT_TIMESTAMP'),
            'status' => $this->integer(11)->notNull(),
            'created_at' => $this->date(),
            'updated_at' => $this->date(),
            'created_by' => $this->bigInteger(20),

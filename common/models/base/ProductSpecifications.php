...
/**
 * This is the base model class for table "{{%taban_product_specifications}}".
 *
 * @property integer $id
...
class ProductSpecifications extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\models\TabanProductSpecificationsQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\ProductSpecificationsQuery(get_called_class());

...
/**
 * This is the base model class for table "{{%taban_page}}".
 *
 * @property integer $id
...
class Page extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\common\models\Menus::className(), ['pageID' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\TabanPageQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\PageQuery(get_called_class());

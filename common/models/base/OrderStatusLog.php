...
/**
 * This is the base model class for table "{{%taban_order_status_log}}".
 *
 * @property integer $id
...
class OrderStatusLog extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\models\TabanOrderStatusLogQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\OrderStatusLogQuery(get_called_class());

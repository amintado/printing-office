...
/**
 * This is the base model class for table "{{%taban_ticket_file}}".
 *
 * @property integer $id
 ...
 *
 * @property \common\models\TicketBody $body
 */
class TicketFile extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasOne(\common\models\TicketBody::className(), ['id' => 'id_body']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\TabanTicketFileQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\TicketFileQuery(get_called_class());

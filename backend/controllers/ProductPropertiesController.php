...
use common\models\ProductPropertiesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ProductPropertiesController implements the CRUD actions for ProductProperties model.
 */
class ProductPropertiesController extends Controller
{
    ...
    /**
     * Lists all ProductProperties models.
     * @return mixed
     */
    ...
    /**
     * 
     * Export ProductProperties information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new ProductProperties model by another data,

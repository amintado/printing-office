...
use common\models\base\product\dimensions\Files;
use common\models\base\product\dimensions\FixedDimensions;
use common\models\base\product\dimensions\MultifixedDimensions;
use common\models\base\product\dimensions\variableDimensions;
...
class ProductController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['add-product-gallery', 'add-product-specifications', 'add-product-step-property', 'add-product-technical-specification', 'upload', 'delete-pic', 'save-as-new', 'dimension-form-multiple', 'dimension-form-fixed', 'dimension-form-variable','add-file','add-tiraj','add-stair-tiraj'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => true,
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $model->hash();
            $model->settings=Json::encode(Yii::$app->request->post());
            $model->save();
     ...
     * @return mixed
     */
    public function actionAddProductGallery()
    {
     ...
     * @return mixed
     */
    public function actionAddProductSpecifications()
    {
        if (Yii::$app->request->isAjax) {
     ...
     * @return mixed
     */
    public function actionAddProductStepProperty()
    {
        if (Yii::$app->request->isAjax) {
     ...
     * @return mixed
     */
    public function actionAddProductTechnicalSpecification()
    {
        if (Yii::$app->request->isAjax) {
    ...
    //<forms Actions>
    public function actionDimensionFormMultiple(){
        $model=new MultifixedDimensions();
//        if (Yii::$app->request->isAjax && $model->load(Yii::$app->request->post())) {
//            Yii::$app->response->format = Response::FORMAT_JSON;
//            return ActiveForm::validate($model);
//        }
        return $this->renderAjax('/product/forms/dimensions/_form_multifixed_dimentions.php',
            [
                'model'=> $model,
                'id'=> Yii::$app->request->post()['id']
            ]);
    }
    public function actionDimensionFormVariable(){
        $model=new variableDimensions();
//        if (Yii::$app->request->isAjax && $model->load(Yii::$app->request->post())) {
//            Yii::$app->response->format = Response::FORMAT_JSON;
//            return ActiveForm::validate($model);
//        }
        return $this->renderAjax('/product/forms/dimensions/_form_variable_dimentions.php',
            [
                'model'=> $model,
                'id'=> Yii::$app->request->post()['id']
            ]);
    }
    public function actionDimensionFormFixed(){
        $model=new FixedDimensions();
//        if (Yii::$app->request->isAjax && $model->load(Yii::$app->request->post())) {
//            Yii::$app->response->format = Response::FORMAT_JSON;
//            return ActiveForm::validate($model);
//        }
        return $this->renderAjax('/product/forms/dimensions/_form_fixed_dimension.php',
            [
                'model'=> $model,
                'id'=> Yii::$app->request->post()['id']
            ]);
    ...
    public function actionAddFile(){
        $model=new \common\models\base\product\file\Files();
       return $this->renderAjax('forms/file/_form',
            [
                'model' => $model,
                'id'=> Yii::$app->request->post()['id']
    ...
    public function actionAddTiraj(){
        $model=new \common\models\base\product\tiraj\Tiraj();
       return $this->renderAjax('forms/tiraj/_form',
            [
                'model' => $model,
                'id'=> Yii::$app->request->post()['id']
            ]
     ...
     public function actionAddStairTiraj(){
            $model=new \common\models\base\product\tiraj\Stair();
           return $this->renderAjax('forms/tiraj/stair',
                [
                    'model' => $model,
                    'id'=> Yii::$app->request->post()['id']
                ]
